      ...
      <div className="flex-1 flex items-center justify-center px-4 py-8">
        <div className="max-w-2xl w-full text-center">
          <div className="mb-8 flex justify-center">
            <Link href="/landing" className="cursor-pointer hover:opacity-80 transition-opacity">
              <Image
                src={logoSrc}
                alt="Otto"
                width={200}
          ...
          <div className="mt-8 flex justify-center">
            <Link 
              href="https://www.threads.com/@ottoadvocate" 
              target="_blank" 
            ...
            >
              <Image
                ...
                className="w-5 h-5"
              />
              <span className="text-sm">Follow us on Threads</span>
            </Link>
          </div>
        </div>
      </div>
